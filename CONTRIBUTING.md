# Contributing to botscaffold

Thanks for your interest in improving botscaffold! This project welcomes issues, feature requests, and pull requests.

## Getting Started

```bash
git clone https://github.com/<your-org>/botscaffold.git
cd botscaffold
